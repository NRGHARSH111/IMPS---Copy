  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const transactionData = {
        ...
        accountNumber: `${formData.orgElementCode}${formData.accountHeadCode}${formData.accountNo}`,
        ...
        withdrawableAmount: formData.withdrawableAmount,
        beneficiaryMmid: formData.beneficiaryMmid,
        beneficiaryMobile: formData.beneficiaryMobileNo,
        beneficiaryIfscCode: formData.beneficiaryIfscCode,
        beneficiaryBankName: formData.beneficiaryBankName,
        beneficiaryBranchName: formData.beneficiaryBranchName,
      ...
      alert('Error! Unable to save transaction. Please check your connection or try again later.');
    } finally {
      setIsSubmitting(false);
    }
  };
